...
export default async function HomePage(){
 ...
 <div className="rh2-line">
  ...
  <a className="rh2-next rh2-next-active" href="https://barber-flow-git-beautytix-ref10.vercel.app/login"><span>02</span><div><small>PRODUTO ATIVO · LINHA BELEZA</small><h3>BeautyTix.</h3></div><p>Gestão completa para salões, estética e negócios de beleza. <b>ACESSAR PRODUTO <ArrowUpRight/></b></p></a>
 </div></section>
