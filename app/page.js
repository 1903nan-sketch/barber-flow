...
export default function HomePage(){return <main className="ruptix-hub rh-v2">
 <nav className="rh2-nav"><Link href="/" className="rh2-logo">RUPTIX<span>®</span></Link><div><a href="#produtos">PRODUTOS</a><a href="#sobre">SOBRE</a></div><Link href="/login" className="rh2-client">ÁREA DO CLIENTE <ArrowUpRight/></Link></nav>
 ...
 <div className="rh2-next"><span>02</span><div><small>EM DESENVOLVIMENTO</small><h3>Próximo<br/>produto.</h3></div><p>O ecossistema Ruptix está só começando.</p></div></section>
