...
export default async function HomePage(){
 ...
 <div className="rh2-line">
  ...
  <div className="rh2-next"><span>02</span><div><small>EM DESENVOLVIMENTO · LINHA BELEZA</small><h3>BeautyTix.</h3></div><p>Software da linha de beleza voltado a salões, estética e operações do segmento.</p></div>
 </div></section>
