...
export default function LoginPage(){
 ...
 return <main className={styles.page}>
  <section className={styles.brand}><div className={styles.logo}><Scissors aria-hidden="true"/>BeautyTix</div><div><span className={styles.kicker}>GESTÃO QUE TRANSFORMA</span><h1>Mais controle.<br/>Mais clientes.<br/><em>Mais crescimento.</em></h1><p>Administre sua negócio de beleza de qualquer lugar, com tudo o que você precisa em um só sistema.</p></div><small>BeautyTix · by Ruptix</small></section>
